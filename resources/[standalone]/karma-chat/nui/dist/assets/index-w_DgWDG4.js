          ...
          W(
            (o) => {
              var c = e.multiline,
                  ...
                  gradient = `linear-gradient(45deg, ${u}, rgba(34, 37, 48, 0.9) 2rem, rgba(34, 37, 48, 0.9) 100%)`,
                  borderColor = u;
              return (
                c !== o.e && Ne(t, "aria-multiline", (o.e = c)),
                gradient !== o.t &&
                  ((o.t = gradient) != null
                    ? (t.style.setProperty("background", gradient),
                       t.style.setProperty("border-left", `calc(0.092592592vh * 2) solid ${borderColor}`))
